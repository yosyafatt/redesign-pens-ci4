    ...
    <section class="mb-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <h1 class="heading mb-2">Selayang Pandang</h1>
    ...
    <section class="sub-section text-white">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <a href="<?= current_url(); ?>/visi-misi" class="btn shadow-sm btn-custom mt-2">Selengkapnya <span class="ml-4"><i class="fas fa-arrow-right"></i></span></a>
            </div>
        </div>
    </section>
